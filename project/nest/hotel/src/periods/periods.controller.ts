import { Controller, Get, Put, ParseIntPipe, HttpStatus, HttpCode, Delete, Param, Body, Post, Query, UsePipes, ValidationPipe, HttpException } from '@nestjs/common';
...
updatePeriod(@Param('id', ParseIntPipe) id: number,
